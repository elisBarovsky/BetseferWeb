<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminDashbord.aspx.cs" Inherits="AdminDashbord" %>
...
<div class="wrapper boxed-wrapper">
  <header class="main-header"> 
    ...
    <span class="logo-mini"><img src="Images/BetseferLogo-n.png" alt=""></span> 
    <!-- logo for regular state and mobile devices --> 
    <span class="logo-lg"><img src="Images/BetseferLogo_NN.png" alt=""></span> </a> 
    ...
    <nav class="navbar blue-bg navbar-static-top"> 
      ...
      <div class="navbar-custom-menu" runat="server">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-envelope-o"></i>
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <ul class="menu">
                  <li><a href="#"> 
                    <div class="pull-left" runat="server">    <asp:Image ID="UserImg" runat="server" class="img-circle" /> <span class="profile-status online pull-right"></span></div>
          ...
          <li class="dropdown user user-menu p-ph-res"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <asp:Image ID="UserImg1" runat="server" class="user-image" />   <span class="hidden-xs"> </span> </a>
            <ul class="dropdown-menu right">
              <li class="user-header right">
                <div class="pull-left user-img" runat="server"><asp:Image ID="UserImgimg" runat="server" class="img-responsive" /></div>
  ...
  <aside class="main-sidebar"> 
    ...
    <section class="sidebar"> 
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="active treeview"> <a href="AdminDashbord.aspx"> <i class="fa fa-home"></i> <span>דף הבית</span> </a>
        </li>
